...
/*2.	Para o mesmo algoritmo anterior, além de considerar o nome do documento – usuário, acrescente o numero de privilégio.
Caso o privilégio for:
-> 1, o documento deverá ser o primeiro a ir para a fila de impressão.
-> 2, a fila poderá ter seu fluxo normalmente.
*/
